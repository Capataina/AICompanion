...
Verification on 2026-09-10 matched all 2,032 native collision comparisons. The production survival action escaped the captured pool in 129 ticks on three consecutive native runs, with 12 of the fixture's initial 30 breath units remaining. The portable historical corpus finished 86 routes, reached 31 partial ends and left 14 incomplete, against 81/31/19 at this work's baseline; no previously passing follower case regressed. Five planner inputs remain skipped and model-closed regions do not prove physical impossibility. The full corpus therefore remains non-green. These checks establish the recorded fixtures, not reliable movement through every live cave or compatibility with every mod. The next acceptance is a recorded unnarrated playtest, including live timing and follow distance, and the remaining cases stay open under the navigation roadmap.
