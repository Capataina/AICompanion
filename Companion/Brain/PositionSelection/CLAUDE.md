...
Retreat serves safety and does not require an attack trajectory. Its geometry may prefer a line to an enemy, but an unavailable shot cannot remove every safety destination. The movement controller remains responsible for actual travel and collision validation.
