...
/// _ half block, { pass-through half block, \ and / floor slopes, ( and ) pass-through floor
/// slopes (solid below the line drawn), &lt; and &gt; ceiling
...
public sealed class TextTileWorld : ITileWorld
{
    ...
    public bool PassThrough(int x, int y) => At(x, y) is '=' or '(' or ')' or '{';
    ...
    public static TileShape ShapeOf(char c) => c switch
    {
        ...
        '=' => TileShape.Platform,
        '_' or '{' => TileShape.Half,
        '\\' or '(' => TileShape.SolidLowerLeft,
        '/' or ')' => TileShape.SolidLowerRight,
    ...
    public static char Glyph(TileShape shape, bool water, bool lava, bool passThrough) => shape switch
    {
        TileShape.Solid => '#',
        TileShape.Platform => '=',
        TileShape.Half => passThrough ? '{' : '_',
        TileShape.SolidLowerLeft => passThrough ? '(' : '\\',
        TileShape.SolidLowerRight => passThrough ? ')' : '/',
        TileShape.SolidUpperLeft => '<',
        TileShape.SolidUpperRight => '>',
        _ => lava ? 'L' : water ? '~' : '.',
    };
