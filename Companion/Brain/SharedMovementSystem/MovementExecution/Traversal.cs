...
/// </summary>
public enum TraversalFault { None, Timeout, Misland, Blocked, Stuck, Interrupted }
...
public abstract class Traversal
{
    ...
    /// <summary>
    /// Captures mutable execution state for a retained macro transition. Planning edges remain
    /// stateless; only the executor copies this state before simulating or resuming controls.
    /// </summary>
    public virtual object? CaptureExecutionState() => null;

    /// <summary>Restores a snapshot created by this traversal type.</summary>
    public virtual void RestoreExecutionState(object? state) { }

    /// <summary>Copies policy configuration; mutable execution belongs to the value snapshot.</summary>
    public Traversal CopyForExecution() => (Traversal)MemberwiseClone();
