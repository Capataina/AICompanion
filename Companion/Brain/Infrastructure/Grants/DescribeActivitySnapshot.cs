...
public readonly record struct ActivitySnapshot(ulong Tick, long ActivityId, PurposeFamily? Family,
    string? Activity, ActivityPhase Phase, bool Downed, bool Recovering, bool MovementStalled)
{
    public bool Suspended => Phase == ActivityPhase.Suspended || Downed || Recovering;
}
