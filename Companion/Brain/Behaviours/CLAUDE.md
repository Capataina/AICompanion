...
`IsExcursion` declares whether an action is optional time away from the player. It defaults to true, so newly added opportunistic actions automatically yield to regroup pressure. Keeping company, protection and the transitional kiting adapter opt out because they maintain companionship or immediate safety. Keeping company lives in PurposeFamilies/NearbyAssistance and owns reunion, rest and nearby movement as one activity. Environmental escape belongs to SharedSafety outside ordinary activity selection. Independent weapon firing remains outside the movement competition; a follow request can still shoot while travelling.
