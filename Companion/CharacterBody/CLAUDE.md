...
The downed path suspends the brain's current activity and enters its common control finaliser with an unavailable hand before recording the tick. This is a lifecycle call, not recorder-driven gameplay: turning recording off cannot leave the old activity executing. Repeated downed ticks do not repeatedly release the interrupted physical method. Recovery clearance may change the applied movement owner from the requested downed hold; the retained control grant preserves both.
