...
[^1]: [ContinueRouteSearch.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/ContinueRouteSearch.cs), `Advance`, `Result`, `EstimatedTicks`; [Reachability.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/Reachability.cs); [Navigator.cs](../../Companion/Brain/SharedMovementSystem/MovementExecution/Navigator.cs).
[^2]: [AStar.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/AStar.cs), `OneWay`, `RememberedStepHasReturn`; [ChooseUsefulPosition.cs](../../Companion/Brain/PositionSelection/ChooseUsefulPosition.cs), `RefreshReach`; [ObservePlayer.cs](../../Companion/Brain/WorldObservation/ObservePlayer.cs), `Trail`.
[^3]: [NavPath.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/NavPath.cs), `NavNode`; [BodyState.cs](../../Companion/Brain/SharedMovementSystem/BodySimulation/BodyState.cs); [DescribeMovementCapabilities.cs](../../Companion/Brain/SharedMovementSystem/MovementAbilities/DescribeMovementCapabilities.cs).
[^4]: [Traversal.cs](../../Companion/Brain/SharedMovementSystem/MovementExecution/Traversal.cs), `MovementCost`; [ContinueRouteSearch.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/ContinueRouteSearch.cs), `Distance`.
[^5]: [MovementExecution/CLAUDE.md](../../Companion/Brain/SharedMovementSystem/MovementExecution/CLAUDE.md), historical results and limits; [PlanLocalMovement.cs](../../Companion/Brain/SharedMovementSystem/MovementExecution/PlanLocalMovement.cs); [SimulateTerrariaBody.cs](../../Companion/Brain/SharedMovementSystem/TerrariaIntegration/SimulateTerrariaBody.cs). Historical measurements are not newly rerun tests.
[^6]: [RememberExecutedRoutes.cs](../../Companion/Brain/SharedMovementSystem/RoutePlanning/RememberExecutedRoutes.cs), `Record`, `Suffixes`, `Fingerprint`.
