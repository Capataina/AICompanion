...
└─ Momentum, Stops and the One-Mover Design.md  why the companion stops on every descent, the ledger of movement attempts, prior art on momentum-keeping travel, and the entry-speed graph design
```
