...
**This file is the implementation plan for Proposal 1, originally prepared against checkout `4755e3b` on 12 September 2026. Implementation landed 13 September 2026: the three-family production chooser, shared-safety migration, observer contracts, HUD icons, README System In Place, and the implementation ledger are in source.** Remaining P14 obligations that need a person — a recorded playtest of this build, owner look at the notch, slope walking — are named in the [implementation ledger](<../../Evaluation and Observability/Proposal 1 Implementation Ledger.md>) rather than left as in-progress packages. Recheck current code and executable checks when continuing. Unbuilt mastery abilities and job-chaining (Proposal 3) remain explicit dependencies, not claimed current-kit acceptance. The original research source baseline remains historical evidence.
