...
[^internal]: [Historical reconstruction](<../Pivotal Decisions and Conversation Evidence.md>), [implementation audit](<../../Implementation Evidence/Decisions, Activities and Shared Controls.md>) and [recorded episodes](<../../Evaluation and Observability/Recorded Episodes and Measurement Limits.md>).
