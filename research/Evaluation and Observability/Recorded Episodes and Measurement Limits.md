...
[^reader]: `Tools/SessionReport/CheckTheFight.cs`, `HuntingHadAWeaponThatCouldReach`, baseline lines 292–325. The branch tests `Contains("outside-reach")` before constructing a definitive universal range explanation.
