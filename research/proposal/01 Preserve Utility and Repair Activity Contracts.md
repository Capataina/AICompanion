...
The top health bar will display the selected family on the left and its activity on the right. Both consume one coherent activity snapshot; approaching, blocked, suspended, recovery and downed states must not falsely display productive work. Exact compact labels and rendering are a design checkpoint, with native offscreen coverage for transitions, long labels and viewport scales. The failure analysis owns the detailed requirement and proposed recorder fields.
