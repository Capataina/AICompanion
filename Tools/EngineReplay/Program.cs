...
if (args.Contains("--retained-course-core")) return VerifyCourseCore.Run() + VerifyProjectionContracts.Run() + VerifyCourseOrderProjection.Run() + VerifyCompanionshipForecast.Run();
