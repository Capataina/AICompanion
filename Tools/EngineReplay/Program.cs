...
int AttackPlanning() =>
    RunOneRow.Case("company fights from inside the predicted region", () => VerifyAttackPlanning.CompanyFightsFromInsideThePredictedRegion())
        ...
        + RunOneRow.Case("attack planning on a forty-hostile crowd is measured unbounded and under the tick's own allowance", () => VerifyAttackPlanning.MeasurePlanningOnAFortyHostileCrowd())
