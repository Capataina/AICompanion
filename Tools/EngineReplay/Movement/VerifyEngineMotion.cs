...
internal static class VerifyEngineMotion
{
    ...
    private static IEnumerable<(string Name, Func<int> Body)> DefaultCases() => new (string, Func<int>)[]
    {
        ...
        ("the live brain tick asks a course what to do, retains it, and observes companionship on the way", VerifyTheCourseOwnsTheTick.Run),
        ...
        ("an attempt is opened, concluded and identified by the activity owner alone", VerifyPreparedActivities.Run),
