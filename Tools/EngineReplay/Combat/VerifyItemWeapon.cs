...
internal static class VerifyItemWeapon
{
    ...
    private static void APistolFiresTheMusketBallsProjectileAtTheComposedSpeed()
    {
        ...
        // A bullet flies straight, so the shot must have been solved on the direct line.
        Require(MathF.Abs(bullet.velocity.Y) < .5f, $"a bullet at a level target is a flat shot; vy={bullet.velocity.Y}");
    }
